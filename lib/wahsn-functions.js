module.exports = (function() {
  ...
  // Delete account data from a dataset
  function deleteDatasetAccount(input, output, context) {
    let datasetMapData = [];
    let datasetAccountsData = [];
    let datasetMapDictionary = {};
  ...
  function databot(input, output, context) {
    switch (input.function) {
      ...
      case "deleteDatasetAccount":
        deleteDatasetAccount(input, output, context)
          .catch((err) => {
            output.error("Error: %s", err.message);
          });
        break;
